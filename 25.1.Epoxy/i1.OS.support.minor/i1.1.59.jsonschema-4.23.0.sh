# i1.1.59.jsonschema-4.23.0.sh
#

#
# Dependencies Required:
#
#               a.08.91.20.18 Attrs-25.3.0
#               i1.1.58       jsonschema_specifications-2023.12.1
#               i1.1.57       referencing-0.32.1
#               i1.1.56       rpds_py-0.16.2 whl
#
...
export PKGLOG_DIR=$OSLOG/1.1.59
