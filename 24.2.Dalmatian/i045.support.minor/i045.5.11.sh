...
# echo "i045.9.94.build-1.2.1"
# echo "i045.9.94.build-1.2.1" >> $OSLOG_PROCESS

# time { bash i045.9.94.build-1.2.1.sh ; }
...
# echo "i045.9.5.sshpass-1.10"
# echo "i045.9.5.sshpass-1.10" >> $OSLOG_PROCESS

# time { bash i045.9.5.sshpass-1.10.sh ; }
