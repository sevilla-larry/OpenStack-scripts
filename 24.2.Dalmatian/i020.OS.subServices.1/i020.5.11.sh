...
echo "i020.9.01.pbr-6.1.0"
echo "i020.9.01.pbr-6.1.0" >> $OSLOG_PROCESS

time { bash i020.9.01.pbr-6.1.0.sh ; }
...
echo "i020.9.02.stevedore-5.3.0"
echo "i020.9.02.stevedore-5.3.0" >> $OSLOG_PROCESS

time { bash i020.9.02.stevedore-5.3.0.sh ; }
